...
Bayesian UQ capabilities have been implemented in the MOOSE Stochastic Tools Module (STM). When
dealing with computationally expensive finite element models, it is known that Bayesian UQ can become
