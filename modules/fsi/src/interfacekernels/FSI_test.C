...
registerMooseObject("FsiApp", FSI_test);

InputParameters
FSI_test::validParams()
{
...
FSI_test::FSI_test(const InputParameters & parameters)
...
Real
FSI_test::computeQpResidual(Moose::DGResidualType type)
{
  Real r = 0;
...
Real
FSI_test::computeQpJacobian(Moose::DGJacobianType type)
{
