...
/**
 * StretchDecision will help make sample accept/reject decisions in MCMC
 * schemes (for e.g., when performing Bayesian inference).
 */
class StretchDecision : public GeneralReporter, public LikelihoodInterface
{
public:
  static InputParameters validParams();
  StretchDecision(const InputParameters & parameters);
