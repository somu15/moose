 ...
 */
class Dummy_MCMC_I : public Sampler, public VectorPostprocessorInterface // public Sampler, public VectorPostprocessorInterface
{
public:
  static InputParameters validParams();

  Dummy_MCMC_I(const InputParameters & parameters);
...
protected:
  ...
  const unsigned int & _num_samples_chain;
