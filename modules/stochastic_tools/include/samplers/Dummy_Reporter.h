 ...
 */
class Dummy_Reporter : public Sampler, public VectorPostprocessorInterface // public Sampler, public VectorPostprocessorInterface
{
public:
  static InputParameters validParams();

  Dummy_Reporter(const InputParameters & parameters);
