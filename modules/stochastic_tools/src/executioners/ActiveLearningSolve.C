...
InputParameters
ActiveLearningSolve::validParams()
{
  ...
  exec_enum = {EXEC_SAMPLER, EXEC_SUBAPP1};
  params.addParam<ExecFlagEnum>(
      "solve_on", exec_enum, "List of flags indicating when inner system solve should occur.");
  return params;
}

ActiveLearningSolve::ActiveLearningSolve(Executioner * ex)
  : SolveObject(ex)
...
bool
ActiveLearningSolve::solve()
{
  // Initial solve
  _inner_solve->solve();

  for (dof_id_type i = 0; i < 10; ++i)
    _problem.execute(EXEC_SAMPLER);
  // bool multiapp_passed = true;

  for (dof_id_type i = 0; i < 10; ++i)
    _problem.execMultiApps(EXEC_SUBAPP1);
...
//
// PetscErrorCode
// ActiveLearningSolve::monitor(Tao tao, void * /*ctx*/)
// {
//   PetscInt its;
...
//
// PetscErrorCode
// ActiveLearningSolve::objectiveFunctionWrapper(Tao /*tao*/, Vec x, Real * objective, void * ctx)
// {
//   auto * solver = static_cast<ActiveLearningSolve *>(ctx);
//
...
//
// PetscErrorCode
// ActiveLearningSolve::gradientFunctionWrapper(Tao /*tao*/, Vec x, Vec gradient, void * ctx)
// {
//   auto * solver = static_cast<ActiveLearningSolve *>(ctx);
//
//   libMesh::PetscVector<Number> param(x, solver->_my_comm);
...
//
// PetscErrorCode
// ActiveLearningSolve::hessianFunctionWrapper(Tao /*tao*/, Vec x, Mat hessian, Mat /*pc*/, void * ctx)
// {
//   auto * solver = static_cast<ActiveLearningSolve *>(ctx);
//
//   libMesh::PetscVector<Number> param(x, solver->_my_comm);
...
//
// PetscErrorCode
// ActiveLearningSolve::variableBoundsWrapper(Tao tao, Vec /*xl*/, Vec /*xu*/, void * ctx)
// {
//   auto * solver = static_cast<ActiveLearningSolve *>(ctx);
//
...
//
// Real
// ActiveLearningSolve::objectiveFunction()
// {
...
//
// void
// ActiveLearningSolve::gradientFunction(libMesh::PetscVector<Number> & gradient)
// {
//   _form_function->updateParameters(*_parameters.get());
//
...
//
// void
// ActiveLearningSolve::hessianFunction(libMesh::PetscMatrix<Number> & hessian)
// {
//   _form_function->updateParameters(*_parameters.get());
//
...
//
// PetscErrorCode
// ActiveLearningSolve::variableBounds(Tao tao)
// {
//   // get bounds
