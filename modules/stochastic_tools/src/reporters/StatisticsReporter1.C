...
// #include <numeric>
//
// registerMooseObject("StochasticToolsApp", StatisticsReporter1);
//
// InputParameters
// StatisticsReporter1::validParams()
// {
...
// }
//
// StatisticsReporter1::StatisticsReporter1(const InputParameters & parameters)
...
//       // else if (hasReporterValueByName<Real>(r_name))
//       //   declareValueHelper<Real, Real>(r_name);
//       else
...
//   }
//
//   // Stats for Adaptive Monte Carlo
//   // if (isParamValid("vectorpostprocessors"))
//   // {
//   //   const auto & vpp_names = getParam<std::vector<VectorPostprocessorName>>("vectorpostprocessors");
//   //   for (const auto & vpp_name : vpp_names)
...
//     mooseError(
//         "The 'vectorpostprocessors' and/or 'reporters' and/or 'output_reporter' parameters must be defined and non-empty.");
// }
//
// void
// StatisticsReporter1::store(nlohmann::json & json) const
// {
//   Reporter::store(json);
//   if (_ci_method.isValid())
...
// void
// StatisticsReporter1::declareValueHelper(const ReporterName & r_name)
// {
...
//
// template void
// StatisticsReporter1::declareValueHelper<std::vector<Real>, Real>(const ReporterName & r_name);
// template void
// StatisticsReporter1::declareValueHelper<std::vector<int>, Real>(const ReporterName & r_name);
