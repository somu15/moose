...
#include "DESDecision.h"
#include "Sampler.h"
#include "DenseMatrix.h"

registerMooseObject("StochasticToolsApp", DESDecision);

InputParameters
DESDecision::validParams()
{
...
DESDecision::DESDecision(const InputParameters & parameters)
...
void
DESDecision::computeEvidence(std::vector<Real> & evidence,
...
void
DESDecision::computeTransitionVector(std::vector<Real> & tv,
...
void
DESDecision::nextSamples(std::vector<Real> & req_inputs,
                                                   DenseMatrix<Real> & inputs_matrix,
